package com.example.volleywithphpetudiant.adapter;
...
import com.example.volleywithphpetudiant.MainActivity;
import com.example.volleywithphpetudiant.R;
import com.example.volleywithphpetudiant.addEtudiant;
import com.example.volleywithphpetudiant.beans.Etudiant;
import com.example.volleywithphpetudiant.modifyEtudiant;
    ...
    public EtudiantViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // Obtenir la position de l'élément cliqué dans la RecyclerView
...
//                prenom.setText(((TextView)view.findViewById(R.id.textViewPrenom)).getText().toString());
                ...
                AlertDialog dialog = new AlertDialog.Builder(context)
                        .setTitle("Faire le choix")
                        .setMessage("Voulez-vous modifier ou supprimer l'etudiant ?")
                        .setView(popup)
                        .setPositiveButton("modifier", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                Intent intent = new Intent(context, modifyEtudiant.class);
                                Log.d("L'id de l'etudiant" , String.valueOf(etudiantList.get(position).getId()));
                                // Ajouter les données de l'étudiant sélectionné
                                intent.putExtra("id", String.valueOf(etudiantList.get(position).getId()));
                                intent.putExtra("nom", etudiantList.get(position).getNom());
                                intent.putExtra("prenom", etudiantList.get(position).getPrenom());
                                intent.putExtra("ville", etudiantList.get(position).getVille());
